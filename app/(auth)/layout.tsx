...
export default function AuthLayout({
    ...
    return (
        <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2 bg-[linear-gradient(117deg,#FAF1E4_30.77%,#DFECF3_87.02%)] relative overflow-hidden">
            {/* Background Vector - Top Left - Whole Page */}
            <svg
                ...
                viewBox="0 0 794 420"
                fill="none"
                className="absolute top-0 left-0 w-auto h-auto pointer-events-none  z-0"
            >
            ...
            {/* Background Vector - Top Right - Whole Page */}
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="902"
                height="587"
                viewBox="0 0 902 587"
                fill="none"
                className="absolute top-0 right-0 w-auto h-auto pointer-events-none z-0"
            >
            ...
            {/* Background Vector - Bottom Left - Whole Page */}
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="191"
                height="254"
                viewBox="0 0 191 254"
                fill="none"
                className="absolute  bottom-0 left-0 w-auto h-auto pointer-events-none z-0"
            >
            ...
            {/* Background Vector - Bottom Right - Whole Page */}
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="658"
                height="168"
                viewBox="0 0 658 168"
                fill="none"
                className="absolute bottom-0 right-[-4%] w-auto h-auto pointer-events-none z-0"
            >
